...
import ParceiroTechnoGraphics from "../../../components/Parceiro/TechnoGraphics";
...
const Index = () => {
    ...
    const informationOFPage = {
        "title": "Quem é Ultimate TechnoGraphics",
    ...
    return (
        <>
            <Desktop />
            <ParceiroTechnoGraphics item={informationOFPage} />
            {/* <!-- Footer --> */}
